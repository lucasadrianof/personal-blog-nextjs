...
const MenuLink = ({ icon, href, onClick, text }: MenuItemLink) => {
  ...
  const classes =
    'flex items-center px-5 py-3 rounded-md font-medium text-sm bg-gray-850 hover:text-white hover:bg-gradient-to-r from-brand-background-element to-[#DD2476]'
